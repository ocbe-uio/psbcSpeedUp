...
void settingInterval_cpp( const arma::vec, const arma::vec, const arma::vec, int, arma::mat&, arma::mat&, arma::mat&, arma::vec& );
double updateLambda_GL_cpp( int, int, double, double, arma::vec );
...
arma::vec updateBH_cpp( arma::mat&, arma::vec, arma::vec&, int, int, arma::vec );
void updateRP_clinical_cpp( int, int, const arma::mat, arma::vec&, arma::vec&, arma::mat&, int, arma::vec, double, arma::mat&, arma::vec&, arma::vec&, arma::vec, arma::uvec& );
void updateRP_genomic_cpp( int, const arma::mat, arma::vec&, arma::vec&, arma::mat&, int, arma::mat&, arma::vec&, arma::vec&, arma::vec, arma::uvec& );
void updateRP_genomic_rw_cpp( int, const arma::mat, arma::vec&, arma::vec&, arma::mat&, int, arma::vec, double, arma::mat&, arma::vec&, arma::vec&, arma::vec, arma::uvec& );
