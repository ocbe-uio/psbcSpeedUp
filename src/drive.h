...
Rcpp::List psbcSpeedUp_internal(const std::string &dataFile, const unsigned int p, const unsigned int q, const Rcpp::List &hyperParFile, // const std::string& initialParFile,
