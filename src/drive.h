...
void updateRP_clinical_cpp( int, int, const arma::mat, arma::mat&, arma::mat&, arma::mat&, unsigned int, arma::vec, double, arma::mat&, arma::mat&, arma::mat&, arma::vec, arma::uvec& );
void updateRP_genomic_cpp( int, const arma::mat, arma::mat&, arma::mat&, arma::mat&, unsigned int, arma::mat&, arma::vec&, arma::vec&, arma::vec, arma::uvec& );
void updateRP_genomic_rw_cpp( int, const arma::mat, arma::mat&, arma::mat&, arma::mat&, unsigned int, arma::vec, double, arma::mat&, arma::vec&, arma::vec&, arma::vec, arma::uvec& );
